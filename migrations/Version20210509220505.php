 ...
 */
final class Version20210509220505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_intervention ADD statut ENUM(\'EnAttente\', \'EnCours\', \'OK\') NOT NULL COMMENT \'(DC2Type:StatutType)\'');
